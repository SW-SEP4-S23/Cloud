...
describe("Co2Controller (e2e)", () => {
  ...
  it("/enviroment/co2?startDate&endDate (GET)", () => {
    return request(app.getHttpServer())
      .get(
        "/enviroment/co2?startDate=2021-01-01T00:00:00.000Z&endDate=2021-01-01T00:10:00.000Z",
      )
      .expect(200)
      .expect([
  ...
  it("/enviroment/co2?startDate&endDate (GET)", () => {
    return request(app.getHttpServer())
      .get(
        "/enviroment/co2?startDate=2021-01-01T00:00:00.000Z&endDate=2021-01-01T01:40:00.000Z",
      )
      .expect(200)
      .expect([
        { timestamp: "2021-01-01T00:00:00.000Z", co2: 400 },
  ...
  it("/enviroment/co2?startDate&endDate get dates not in seed data(GET)", () => {
    return request(app.getHttpServer())
      .get(
        "/enviroment/co2?startDate=2020-01-01T00:00:00.000Z&endDate=2020-01-01T00:10:00.000Z",
      )
      .expect(200)
      .expect([]);
  });
